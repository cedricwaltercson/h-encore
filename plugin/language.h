...
language_container_t language_japanese = {  
  ...
  L"キャンセル",
  L"Pluginsのリロード",
  L"Any plugin installedのリロードが完了しました。",
  L"端末の再起動",
  L"コンテンツ ダウンローダー",
  L"メモリーカードとのリンクを解除する",
...
language_container_t language_english_us = {
  ...
  L"Cancel",
  L"Reload Plugins",
  L"Any plugin installed has been successfully reloaded.",
  L"Reboot Device",
...
language_container_t language_french = {
  ...
  L"Valider",
  L"Annuler",
  L"Recharger le fichier Configuration de Plugin",
  L"Le fichier configuration de Plugin a bien été rechargé.",
...
language_container_t language_spanish = {
  ...
  L"Cancelar",
  L"Recargar Plugins",
  L"Any plugin installed ha sido recargado correctamente.",
...
language_container_t language_german = {
  ...
  L"Bestätigen",
  L"Abbrechen",
  L"Die Configuration von Plugin aktualisieren",
  L"Die configuration von Plugin wurde erfolgreich aktualisiert.",
  L"Gerät neustarten",
  L"Inhaltsdownloader",
...
language_container_t language_italian = {
  ...
  L"Annulla",
  L"Ricarica Plugins",
  L"Any plugin installed ricaricato correttamente.",
...
language_container_t language_dutch = {
  ...
  L"Annuleren",
  L"Herlaad Plugins",
  L"Any plugin installed is succesvol herladen.",
  L"Herstart apparaat",
  L"Inhoud downloader",
...
language_container_t language_portuguese_pt = {
  ...
  L"Entrar",
  L"Cancelar",
  L"Recarrege o ficheiro Configuration do Plugin",
  L"O ficheiro Any plugin installed foi recarregado com sucesso.",
...
language_container_t language_russian = {
  ...
  L"Ввод",
  L"Отмена",
  L"Перезагрузить Plugins",
  L"Any plugin installed был успешно перезагружен.",
...
language_container_t language_korean = {
  ...
  L"취소",
  L"Plugins 다시 불러오기",
  L"Any plugin installed를 성공적으로 다시 불러왔습니다.",
  L"기기 다시 시작",
  L"컨텐츠 다운로더",
  L"메모리 카드 언링크",
...
language_container_t language_finnish = {
  ...
  L"Valitse",
  L"Peruuta",
  L"Lataa Plugins uudelleen",
  L"Any plugin installed uudelleenladattiin onnistuneesti.",
...
language_container_t language_swedish = {
  ...
  L"Avbryt",
  L"Ladda om Plugins",
  L"Any plugin installed har laddats om.",
  L"Starta om enhet",
...
language_container_t language_danish = {
  ...
  L"Afbryd",
  L"Genindlæs Plugins",
  L"Any plugin installed er blevet genindlæst.",
  L"Genstart enhed",
  L"Indholdshenter",
...
language_container_t language_norwegian = {
  ...
  L"Velg",
  L"Avbryt",
  L"Last på nytt Plugins",
  L"Any plugin installed har blitt lastet.",
...
language_container_t language_polish = {
  ...
  L"OK",
  L"Anuluj",
  L"Załaduj ponownie Configuration Plugin",
  L"configuration Plugin został pomyślnie załadowany ponownie.",
...
language_container_t language_portuguese_br = {
  ...
  L"Entrar",
  L"Cancelar",
  L"Recarrege o arquivo Configuration do Plugin",
  L"Any plugin installed foi recarregado com sucesso.",
  L"Reiniciar o dispositivo",
  L"Baixar Conteúdo",
...
language_container_t language_turkish = {
  ...
  L"Gir",
  L"İptal",
  L"Plugins'yi yeniden yükle",
  L"Any plugin installed başarılı bir şekilde yeniden yüklendi.",
